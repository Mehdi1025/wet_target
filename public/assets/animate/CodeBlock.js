import{jsx as _jsx,jsxs as _jsxs}from"react/jsx-runtime";import{motion}from"framer-motion";import{getSandpackCssText,SandpackCodeEditor,SandpackLayout,SandpackProvider}from(location.origin+"/assets/animate/codesandbox_sandpack_react.js");import{addPropertyControls,ControlType,withCSS}from"framer";import{supportedLanguages}from(location.origin+"/assets/animate/types.js");import{useLanguageAsync}from(location.origin+"/assets/animate/useLanguageAsync.js");import{getFileExtensions,titleCase,useBorder,useIsOnCanvas,usePadding,useRadius}from(location.origin+"/assets/animate/utils.js");import{darkThemeVariables,getVariablesForTheme,getVariableTheme,lightThemeVariables,themeKeys}from(location.origin+"/assets/animate/theming.js");const DEFAULT_CODE=`// Paste a code snippet
...
// Selectors need high enough specificity to win against even breakpoint-specific font-sizes
`
...
export const __FramerMetadata__ = {"exports":{"default":{"type":"reactComponent","name":"CodeBlock","slots":[],"annotations":{"framerSupportedLayoutWidth":"fixed","framerIntrinsicHeight":"200","framerContractVersion":"1","framerIntrinsicWidth":"500","framerSupportedLayoutHeight":"any","framerComponentPresetProps":"borderRadius, border, font, themeMode, theme, lightTheme, darkTheme, background, padding","framerDisableUnlink":"*"}},"__FramerMetadata__":{"type":"variable"}}}
